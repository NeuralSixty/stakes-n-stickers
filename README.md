...
- [Stakes on New Run](#stakes-on-new-run)
  ...
  - [Sticker Types](#sticker-types)
    ...
    - [Delayed stickers (Debuffed on purchase for 3 rounds, effects double afterwards)](#delayed-stickers-debuffed-on-purchase-for-3-rounds-effects-double-afterwards)
...
I categorize two types of difficulty that exist within Balatro as follows:
...
I believe that static difficulty is considered artificial difficulty, meaning that the challenge it's supposed to provide has a high risk of feeling unfair and lacking a sense of accomplishment due to a level of superficiality in designing and developing it. While I feel that static difficulty is now an ingrained component of Balatro, and therefore a decision was made in this mod not to remove it, it was important to properly separate static difficulty from emergent complexity and give the player the freedom to choose the static difficulty they wish for before a run starts.

### Emergent Complexity

Emergent complexity is a type of organic difficulty that generally feels fair to the player and often provides a level of accomplishment in surmounting it due to the immersion it creates for the player. This immersion is the result of emergent situations that encourage the player into analyzing and developing complex strategies to surpass them. In other words, emergent complexity adds layers of decision-making to the various situations the player might find themselves in at any point in time during the run.
...
Stake materials reflect the static difficulty provided by the scaling of the former Green and Purple stakes. In this regard, the mechanics for these stakes are as follows:

- Plastic represents base scaling.
- Clay represents the increased scaling of the former Green stake.
- Ceramic represents the increased scaling of the former Purple stake.

Despite being static difficulty and, therefore, artificial difficulty, I believe the vanilla scaling can still be used as a measure of evaluating one's own skill for experienced players who are already used to playing in the former Gold Stake.
...
Stake colors reflect the emergent complexity provided by the vanilla in-run stickers on Jokers, and also provide new forms of this complexity through new in-run stickers.

Despite the resemblance between the overhauled and the former order and usage of the colors, the mechanics have been fundamentally changed:
...
Plastic White Stake, Clay White Stake and Ceramic White Stake are all unlocked at the very beginning, leaving the player to choose which static difficulty they want to start in. Winning a run on a higher Stake Material will also unlock the lower-scaled Materials for that Color.
...
Rental Jokers provide emergent complexity by forcing thoughtfulness on economy. To encourage this thoughtfulness, the effect of the former red stake was removed. More on this at [Note on the former Red Stake effect](#note-on-the-former-red-stake-effect). Therefore, Rental stickers stay on this mod.
...
#### Delayed stickers (Debuffed on purchase for 3 rounds, effects double afterwards)

Delayed Jokers provide emergent complexity by encouraging possibilities of short-term risk leading to higher long-term rewards. Jokers whose effects I consider would either not benefit from or become extremely unfair by being doubled do not receive Delayed stickers. These are:
...
Supercritical Jokers provide emergent complexity by encouraging strategic cyclical thinking. Jokers whose effects I consider would either not benefit from or become extremely unfair by being doubled do not receive Supercritical stickers. These are:
...
This synergy is disabled in the vanilla Balatro due to the obvious drawback of a debuffed Joker occupying a Joker slot forever. However, the probabilistic consequence of this is less synergy variety, since Jokers that happen to contain both Perishable and Eternal are excluded out of the list of total possible Jokers in the pool. More probabilistic variety and, therefore, more complexity is then allowed. If the player is able to deal with the situation, they're rewarded with the Joker becoming Negative.

This also takes effect for Jokers that become debuffed through Toxic Jokers.

#### Delayed and Perishable, Rental, Toxic or Supercritical
...
The vanilla effect states that Small Blinds wouldn't reward any money anymore. However, I believe this to be artificial difficulty, with two reasons for this:
...
- Denying access to money also denies or strongly discourages access to shop items that would otherwise provide the player with more dynamics to deal with challenges. An obvious example of this is a Rental Joker that would otherwise be a fine addition to the player's arsenal. Not denying the small amount of money from the Small Blind allows such a Rental Joker to be affordable while allowing the Rental effect to still be a challenge to the player.

## Note on the former Blue Stake effect

I believe the effect to be controversial in its blatant artificial difficulty and have removed it in favor of organic difficulty.
