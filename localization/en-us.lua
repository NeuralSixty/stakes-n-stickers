return {
    ...
    Joker = {
      ...
      j_sixth_sense = {
        ...
        text = {
          ...
          "create {C:attention}#1#{} {C:spectral}Spectral{} #2#",
          "{C:inactive}(Must have room)",
        },
      },
      j_superposition = {
        name = "Superposition",
        text = {
          "Create {C:attention}#1#{} {C:tarot}Tarot{} #2# if",
      ...
      j_seance = {
        ...
        text = {
          ...
          "{C:attention}#2#{} random {C:spectral}Spectral{} #3#",
          "{C:inactive}(Must have room)",
        },
      },
      j_vagabond = {
        name = "Vagabond",
        text = {
          "Create {C:attention}#2#{} {C:purple}Tarot{} #3#",
          "if hand is played",
      ...
      j_hallucination = {
        ...
        text = {
          ...
          "{C:attention}#3#{} {C:tarot}Tarot{} #4# when any",
      ...
      j_cartomancer = {
        name = "Cartomancer",
        text = {
          "Create {C:attention}#1#{} {C:tarot}Tarot{} #2#",
          "when {C:attention}Blind{} is selected",
          "{C:inactive}(Must have room)",
        },
      },
    ...
    Stake = {
      ...
      stake_purple = {
        ...
        text = {
          ...
          "{C:inactive,s:0.8}(Debuffed on purchase for 3 rounds)",
  ...
  misc = {
    labels = {
      ...
      sns_delayed = "Delayed",
      sns_toxic = "Toxic",
      sns_toxic_stack_one = "Toxic Exposure 1/3",
      sns_toxic_stack_two = "Toxic Exposure 2/3",
      sns_supercritical = "Supercritical"
    },
    dictionary = {
      k_active_ex = "Active!",
